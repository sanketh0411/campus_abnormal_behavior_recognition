...
--
-- Host: localhost
-- Generation Time: Jul 18, 2023 at 11:39 AM
...
--
-- Database: `campus_abnormal_behavior_recognition`
--
CREATE DATABASE IF NOT EXISTS `campus_abnormal_behavior_recognition` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `campus_abnormal_behavior_recognition`;
...
('1mj6vbtz6gpqjqarpau6ufzr3sbc50xd', 'eyJ1c2VyaWQiOjF9:1qLho6:d7WadHLplO1DpAcmx0Cb_ZMqph2H_MyZYeuDsR9_FIU', '2023-08-01 10:19:50.759566'),
...
('wqb4sg8te6zw0csl38eb9jojzvjs104d', 'eyJ1c2VyaWQiOjJ9:1qLizM:sVezBXJeXFzsuZ65GGGWSwuksO0TAYdc5ZHmML5Fd6o', '2023-08-01 11:35:32.335404'),
...
(1, 'Ramesh', 'Ramesh123@gmail.com', 'Ramesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(25, 'Convolutional Neural Network', '61.702127659574465'),
(26, 'Naive Bayes', '68.08510638297872'),
(27, 'SVM', '63.829787234042556'),
(28, 'Logistic Regression', '68.08510638297872'),
(29, 'Gradient Boosting Classifier', '55.319148936170215');
...
(10, 'Improper Behavior', '33.33333333333333'),
(11, 'Proper Behavior', '66.66666666666666');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_student_behavior_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_student_behavior_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Sid` varchar(3000) NOT NULL,
  `Certification_Course` varchar(3000) NOT NULL,
  `Gender` varchar(3000) NOT NULL,
  `Department` varchar(3000) NOT NULL,
  `Height_CM` varchar(3000) NOT NULL,
  `Weight_KG` varchar(3000) NOT NULL,
  `Tenth_Mark` varchar(3000) NOT NULL,
  `Twelth_Mark` varchar(3000) NOT NULL,
  `college_mark` varchar(3000) NOT NULL,
  `hobbies` varchar(3000) NOT NULL,
  `daily_studing_time` varchar(3000) NOT NULL,
  `prefer_to_study_in` varchar(3000) NOT NULL,
  `degree_willingness` varchar(3000) NOT NULL,
  `social_medai_video` varchar(3000) NOT NULL,
  `Travelling_Time` varchar(3000) NOT NULL,
  `Stress_Level` varchar(3000) NOT NULL,
  `Financial_Status` varchar(3000) NOT NULL,
  `part_time_job` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_student_behavior_prediction`
--

INSERT INTO `remote_user_student_behavior_prediction` (`id`, `Sid`, `Certification_Course`, `Gender`, `Department`, `Height_CM`, `Weight_KG`, `Tenth_Mark`, `Twelth_Mark`, `college_mark`, `hobbies`, `daily_studing_time`, `prefer_to_study_in`, `degree_willingness`, `social_medai_video`, `Travelling_Time`, `Stress_Level`, `Financial_Status`, `part_time_job`, `Prediction`) VALUES
(1, '172.217.12.170-10.42.0.42-443-52998-6', 'No', 'Male', 'BCA', '152', '43', '61.6\r\n', '61.67', '75', 'Sports', '1 - 2 Hour', 'Morning', '50%', '1 - 1.30 hour', '1 - 1.30 hour', 'Good', 'good', 'No', 'Improper Behavior'),
(3, '206.126.112.142-10.42.0.151-443-39311-6', 'No', 'Male', 'BCA', '190', '85', '88.2\r\n', '67.5', '60', 'Video Games', '0 - 30 minute', 'Morning', '75%', '1.30 - 2 hour', '1 - 1.30 hour', 'Bad', 'Bad', 'No', 'Proper Behavior'),
(4, '180.149.138.210-10.42.0.211-80-52068-6', 'Yes', 'Male', 'Commerce', '159', '80', '60\r\n', '79', '50', 'Cinema', '30 - 60 minute', 'Morning', '0%', 'More than 2 hour', '1.30 - 2 hour', 'Good', 'Bad', 'No', 'Proper Behavior');

"""campus_abnormal_behavior_recognition URL Configuration
...
from campus_abnormal_behavior_recognition import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Campus_Behavior_Type/$', remoteuser.Predict_Campus_Behavior_Type, name="Predict_Campus_Behavior_Type"),
    ...
    url(r'^View_Campus_Behavior_Type_Ratio/$', serviceprovider.View_Campus_Behavior_Type_Ratio, name="View_Campus_Behavior_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Campus_Behavior_Type/$', serviceprovider.View_Campus_Behavior_Type, name="View_Campus_Behavior_Type"),

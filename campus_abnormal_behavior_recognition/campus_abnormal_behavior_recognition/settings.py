...
ROOT_URLCONF = 'campus_abnormal_behavior_recognition.urls'
...
WSGI_APPLICATION = 'campus_abnormal_behavior_recognition.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'campus_abnormal_behavior_recognition',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
